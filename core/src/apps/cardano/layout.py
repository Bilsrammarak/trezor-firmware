...
ADDRESS_TYPE_NAMES = {
    ...
    CardanoAddressType.REWARD_SCRIPT: TR.cardano__addr_enterprise,
}
...
async def confirm_stake_pool_registration_final(
    ...
    await confirm_properties(
        ...
        (
            ...
            (TR.cardano__valid_since, format_optional_int(validity_interval_start)),
...
async def confirm_collateral_input(
    ...
    await confirm_properties(
        ...
        (
            ...
            (TR.cardano__collateral_input_index, str(collateral_input.prev_index)),
        ),
        br_code=BRT_Other,
    )
