...
reset__check_group_share_title_template = "ZKONTROLOVAT G{} - PODÍL {}"
reset__check_seed_title = "ZKONTROLOVAT SEED"
reset__check_share_title_template = "ZKONTROLOVAT PODÍL #{}"
...
backup__new_wallet_created = "Nová peněženka úspěšně vytvořena."
